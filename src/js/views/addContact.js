...
const AddContact = () => {
    ...
    const handleSave = (e) => {
        ...
        if (contact.id !== null) {
            actions.updateUser(contact.id, contact);
        } else {
            actions.createUser(contact);
        }
        navigate("/");
    };
    ...
    return (
        <div className="container">
            <h1>{contact.id !== null ? "Editar Contacto" : "Crear Contacto"}</h1>
            <form onSubmit={handleSave}>
                ...
                <button type="submit" className="btn btn-primary w-100">
                    {contact.id !== null ? "Guardar cambios" : "Crear Contacto"}
                </button>
            </form>
